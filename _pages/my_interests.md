...
{% include figure.liquid loading="eager" path="assets/img/5.jpg" title="Current Questions" class="img-fluid rounded z-depth-1" %}
Caption here.
...
At this stage, my research began to take a new direction toward human neuroimaging and network-level approaches. Luckily, my master’s lab also conducted human brain MRI studies alongside the animal experiments, and I decided to make a transition from the wet lab to the dry lab. The first few months were honestly rough—I didn’t even know how to open a file without double-clicking it, and every term sounded like a foreign language. Neuroimaging preprocessing and analysis pipelines felt completely disconnected from the wet-lab “protocol” world I was used to. I didn’t know what I didn’t know, and that uncertainty was overwhelming. With help from my labmates(extra thanks to my saviors), I began to weave things together. I still remember the thrill when I first opened a 3D MRI volume, and later when I ran my first voxel-based demo and saw clusters appear on the screen <i>I actuall did this!</i>
